...
*/
	...
	var featureColor = d3.scaleOrdinal()
		//.range (["#FF0000","#FFA500","#FFFF00","#32CD32","#0000FF","#8A2BE2","#FF00FF"]); //vermelho, laranja, amarelo, verde, azul, violeta, magenta (rosa)
	...
	d3.csv("data/data_example.csv", function viz(data) {
