...
*/
	...
	var margin = {top: 20, right: 0, bottom: 30, left: 292}, //bottom: 30
		width = 1300 - margin.left - margin.right,
		height = 350 - margin.top - margin.bottom;
		
	//definição do SVG
	var svg = d3.select("#primeiroSVG")
		.append("svg")
		.attr("width", 1300) //.attr("width", 1450)
		.attr("height", 455) //.attr("height", 495)
		.append("g")
	...
	var subtitle = function() {
		...
		var legend = svg.append("g")
			.attr("transform", "translate(" + (width - 785) + "," + (height - 270) + ")"); //(width - 900) (height - 270)
	...
	var makeVis = function(fileName) {
		...
		function mousemove() {
			var x0 = xScale.invert(d3.mouse(this)[0]); //[0]
				...
				focus.attr("transform", "translate(" + xScale(x0-14) + "," + (361 - margin.top - margin.bottom)+ ")");
				focus2.attr("transform", "translate(" + xScale(x0-14) + "," + (380 - margin.top - margin.bottom)+ ")");
				focus3.attr("transform", "translate(" + xScale(x0-14) + "," + (399 - margin.top - margin.bottom)+ ")");
				focus4.attr("transform", "translate(" + xScale(x0-14) + "," + (418 - margin.top - margin.bottom)+ ")");
				focus5.attr("transform", "translate(" + xScale(x0-14) + "," + (437 - margin.top - margin.bottom)+ ")");
				focus6.attr("transform", "translate(" + xScale(x0-14) + "," + (456 - margin.top - margin.bottom)+ ")");
				focus7.attr("transform", "translate(" + xScale(x0-14) + "," + (340 - margin.top - margin.bottom)+ ")"); //370
				focus8.attr("transform", "translate(" + xScale(x0-14) + "," + (475 - margin.top - margin.bottom)+ ")");
