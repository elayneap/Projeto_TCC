	...
	var makeVis = function(fileName) {
		...
		function mousemove() {
			var x0 = xScale.invert(d3.mouse(this)[0]); //[0]
				...
				focus.attr("transform", "translate(" + 350 + "," + (361 - margin.top - margin.bottom)+ ")");
				focus2.attr("transform", "translate(" + 350 + "," + (380 - margin.top - margin.bottom)+ ")");
				focus3.attr("transform", "translate(" + 350 + "," + (399 - margin.top - margin.bottom)+ ")");
				focus4.attr("transform", "translate(" + 350 + "," + (418 - margin.top - margin.bottom)+ ")");
				focus5.attr("transform", "translate(" + 350 + "," + (437 - margin.top - margin.bottom)+ ")");
				focus6.attr("transform", "translate(" + 350 + "," + (456 - margin.top - margin.bottom)+ ")");
				focus7.attr("transform", "translate(" + 350 + "," + (340 - margin.top - margin.bottom)+ ")");
				focus8.attr("transform", "translate(" + 350 + "," + (475 - margin.top - margin.bottom)+ ")");
